...
public class InterviewChartFragment extends Fragment implements OnChartValueSelectedListener {
    @BindView(R.id.pieChart_interview) PieChart pieChart;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_interview_chart, container, false);
    ...
    private void initChart() {
        ...
        try {
            ...
            realm.executeTransaction(new Realm.Transaction() {
                ...
                public void execute(Realm realm) {
                    float passSize = realm.where(Recruit.class).equalTo("processResult", "합격")
                    ...
                    float failSize = realm.where(Recruit.class).equalTo("processResult", "불합격")
                                                               .equalTo("process", "1차면접")
                                                               .or()
                                                               .equalTo("processResult", "불합격")
                                                               .equalTo("process", "2차면접")
                                                               .or()
                                                               .equalTo("processResult", "불합격")
                                                               .equalTo("process", "최종면접")
        ...
        PieDataSet dataSet = new PieDataSet(entries, "면접");
    ...
    public void onValueSelected(Entry e, Highlight h) {
        ...
        if (e == null) {
            ...
            chartActivity.initRecyclerView(chartActivity.getProcessResults("면접", "합격"));
        } else {
            Toast.makeText(getActivity(), String.valueOf(e), Toast.LENGTH_LONG).show();
